        ...
        ZStack {
            ...
            if showDisclaimer {
                ...
                VStack(spacing: 24) {
                    ...
                    Text("Cattle Images Only")
                        .font(.system(size: 20, weight: .bold))
                        .foregroundColor(Color(red: 0.1, green: 0.1, blue: 0.2))
                    
                    Text("Please ensure you only upload images of cattle (cows, bulls, calves).\n\nThe AI model is specifically trained for cattle diseases and will not provide accurate results for other animals or objects.")
                        .font(.system(size: 15))
                        .multilineTextAlignment(.center)
                        .foregroundColor(.secondary)
                        .lineSpacing(4)
